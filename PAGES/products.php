...
<body>
    ...
    <!------------------------------------------------------------------------ -->
    <section class="gradient" style="background-image: radial-gradient(rgba(0, 0, 0, 0.8), rgba(255, 255, 255, 0)), url(../resource/img/jonathan-borba-Rsfz17HyiAg-unsplash.jpg); background-position: 50% 50%;"></section>
    <!-------------------------------------------------------------------------------- -->
    <?php
    $res = mysqli_query($db,"SELECT * FROM `products_market`");
